...
---
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine)
---
---@class coroutinelib
coroutine = {}
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine.isyieldable)
---
---@param co? thread
---@return boolean
---@nodiscard
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine.close)
---
---@param co thread
...
---开始或继续协程 `co` 的运行。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine.resume)
---
---@param co    thread
---@param val1? any
...
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine.running)
---
...
---以字符串形式返回协程 `co` 的状态。
---
---[查看文档](http://www.lua.org/manual/5.4/manual.html#pdf-coroutine.status)
---
---@param co thread
---@return
---| '"running"'   # 正在运行。
